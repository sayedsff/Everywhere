...
public partial class ModelDefinition : ObservableObject
{
    ...
    /// <summary>
    /// A short description of the model, used for UI representation.
    /// </summary>
    [ObservableProperty]
    [HiddenSettingsItem]
    public partial Customizable<JsonDynamicResourceKey>? Description { get; set; }
    ...
    /// <summary>
    /// Indicates whether the model supports web search capabilities.
    /// </summary>
    [ObservableProperty]
    public partial Customizable<bool> IsWebSearchSupported { get; set; } = false;
